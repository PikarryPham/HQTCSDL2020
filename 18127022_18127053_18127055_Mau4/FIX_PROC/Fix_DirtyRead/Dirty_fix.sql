...
GO
IF OBJECT_ID('dbo.chinhsua_loainha_ban_FIX_DIRTY','P') IS NOT NULL
BEGIN
	drop proc dbo.chinhsua_loainha_ban_FIX_DIRTY
END
go

create proc dbo.chinhsua_loainha_ban_FIX_DIRTY @MANHA CHAR(5) = NULL,@MA_LN CHAR(5) = NULL, @GIABAN INTEGER = NULL, @SLP INTEGER = NULL,
...
begin transaction
	begin try
		...
		BEGIN
			...
			begin
				SET @RETURNCODE = 1;
				SET @RETURNMESS = N'Vui lòng nhập giá bán chia hết cho 100';
...
IF EXISTS(SELECT 1 FROM sys.procedures 
          WHERE Name = 'thongtinchitiet_NB_FIX_DIRTY')
begin
	drop procedure thongtinchitiet_NB_FIX_DIRTY
end
go

create procedure thongtinchitiet_NB_FIX_DIRTY
